...
export const INGREDIENT_CATEGORIES: IngredientCategoryInfo[] = [
  {
    id: 'vitamins',
    name: 'ビタミン',
    description: '体の機能維持に必要な必須栄養素。エネルギー代謝や免疫機能をサポート',
    icon: '🍊',
    color: 'bg-orange-100 text-orange-800',
    count: 13
  },
...
export const MOCK_INGREDIENTS: Ingredient[] = [
  // ビタミン
  {
    ...
    category: 'vitamins',
    description: '強力な抗酸化作用を持つ水溶性ビタミン。コラーゲンの合成に必要で、免疫機能をサポートします。',
    benefits: [
      '抗酸化作用による細胞保護',
      'コラーゲン合成の促進',
      '免疫機能の強化',
  ...
  },
  {
    ...
    category: 'vitamins',
    description: '骨の健康維持と免疫機能調節に重要な脂溶性ビタミン。日光浴により体内で合成されます。',
    benefits: [
      'カルシウムの吸収促進',
      '骨密度の維持',
      '免疫機能の調節',
  ...
  },
  {
    ...
    category: 'vitamins',
    description: '神経機能と赤血球の形成に必要な水溶性ビタミン。主に動物性食品に含まれます。',
    benefits: [
      '神経機能の維持',
      '赤血球の形成',
      'DNA合成のサポート',
  ...
  // ミネラル
  {
    ...
    nameEn: 'Magnesium',
    category: 'minerals',
    description: '300以上の酵素反応に関与する必須ミネラル。筋肉や神経の機能維持に重要です。',
    benefits: [
      '筋肉の収縮・弛緩の調節',
      '神経伝達の正常化',
      'エネルギー代謝のサポート',
  ...
  },
  {
    ...
    nameEn: 'Zinc',
    category: 'minerals',
    description: '免疫機能、創傷治癒、味覚・嗅覚の維持に重要な必須ミネラルです。',
    benefits: [
      '免疫機能の強化',
      '創傷治癒の促進',
      '味覚・嗅覚の維持',
  ...
  // ハーブ
  {
    ...
    category: 'herbs',
    description: 'クルクミンを主成分とする抗炎症作用の高いハーブ。肝機能サポートと関節の健康維持に使用されます。',
    benefits: [
      '抗炎症作用',
      '抗酸化作用',
      '肝機能のサポート',
  ...
  },
  {
    ...
    category: 'herbs',
    description: '血流改善と認知機能のサポートに使用される伝統的なハーブエキスです。',
    benefits: [
      '血流の改善',
      '認知機能のサポート',
      '記憶力の向上',
  ...
  // アミノ酸
  {
    ...
    description: 'バリン、ロイシン、イソロイシンの3つの必須アミノ酸。筋肉の合成と疲労回復をサポートします。',
    benefits: [
      '筋肉合成の促進',
      '筋肉分解の抑制',
      '運動疲労の軽減',
  ...
  },
  {
    ...
    nameEn: 'L-Theanine',
    category: 'amino-acids',
    description: '緑茶に含まれるアミノ酸。リラックス効果と集中力向上をサポートします。',
    benefits: [
      'リラックス効果',
      '集中力の向上',
      'ストレス軽減',
  ...
  // プロバイオティクス
  {
    ...
    category: 'probiotics',
    description: '腸内環境を整える代表的な乳酸菌。消化機能と免疫機能をサポートします。',
    benefits: [
      '腸内環境の改善',
      '消化機能のサポート',
      '免疫機能の強化',
  ...
  // その他
  {
    ...
    category: 'others',
    description: 'EPA・DHAを含む必須脂肪酸。心血管系の健康と脳機能をサポートします。',
    benefits: [
      '心血管系の健康維持',
      '脳機能のサポート',
      '抗炎症作用',
  ...
  },
  {
    ...
    nameEn: 'Coenzyme Q10',
    category: 'others',
    description: '細胞のエネルギー産生に重要な補酵素。心臓機能と抗酸化作用をサポートします。',
    benefits: [
      '心臓機能のサポート',
      'エネルギー産生の促進',
      '抗酸化作用',
...
export function getIngredientsByCategory(category: IngredientCategory): Ingredient[] {
  return MOCK_INGREDIENTS.filter(ingredient => ingredient.category === category);
}
...
export function filterIngredients(filters: Partial<FilterState>): Ingredient[] {
  ...
  if (filters.searchQuery && filters.searchQuery.trim()) {
    ...
    filtered = filtered.filter(ingredient =>
      ...
      ingredient.benefits.some(benefit => benefit.toLowerCase().includes(query))
    );
  }
    ...
    filtered.sort((a, b) => {
      ...
      switch (filters.sortBy) {
        case 'name':
          ...
          break;
        case 'evidence':
          aValue = a.evidenceLevel === 'high' ? 3 : a.evidenceLevel === 'medium' ? 2 : 1;
          bValue = b.evidenceLevel === 'high' ? 3 : b.evidenceLevel === 'medium' ? 2 : 1;
          break;
        case 'popularity':
          aValue = a.popularity;
          bValue = b.popularity;
...
// 目的別成分取得
export function getIngredientsByPurpose(purpose: PurposeCategory): Ingredient[] {
  return MOCK_INGREDIENTS.filter(ingredient => ingredient.purposes.includes(purpose));
}
