                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-3 mb-6">
                            ...
                            <div className="flex flex-col">
                                <span className="font-bold text-xl text-gray-900">サプティア</span>
                                <span className="text-xs text-gray-500 font-medium -mt-1">Suptia</span>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-4">
                            <a
                                ...
                                className="w-10 h-10 bg-white border border-gray-200 rounded-lg flex items-center justify-center hover:border-blue-400 transition-colors duration-200"
