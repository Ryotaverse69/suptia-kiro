...
export default function PurposeCategoryCard({
    ...
    return (
        <button
            onClick={onClick}
            className="w-full text-left bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-200 overflow-hidden group p-4"
        >
