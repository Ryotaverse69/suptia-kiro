...
export function PriceTable({ product, className = '' }: PriceTableProps) {
  ...
  const errorMessage =
    costResult.error || (locale === 'ja' ? '計算エラー' : 'Calculation Error');
    ...
    >
      ...
      <div className='overflow-x-auto'>
        <table
          ...
          aria-label={
            locale === 'ja'
              ? `${product.name}の価格情報テーブル`
              : `Price information table for ${product.name}`
          }
        >
