...
import { ComparisonTable, Product as ComparisonProduct } from "@/components/ComparisonTable";
...
export const metadata = generateSEO({
  ...
  description: "科学的根拠に基づいたサプリメント比較。価格、成分、安全性を総合的に評価し、あなたに最適なサプリメントを見つけます。",
  url: "https://suptia.com/compare",
  keywords: ["サプリメント", "比較", "価格比較", "成分分析", "安全性", "コスト分析"],
});
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">リアルタイム比較</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">パーソナライズ</h3>
              <p className="text-gray-600 text-sm">
                あなたの健康状態に合わせた推奨
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">科学的根拠</h3>
              <p className="text-gray-600 text-sm">
                エビデンスレベルに基づく評価
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">透明性</h3>
              <p className="text-gray-600 text-sm">
                すべての判断基準を明確に表示
              </p>
            </div>
