...
const AIRecommendationSearchBar = dynamic(() => import('@/components/AIRecommendationSearchBar').then(mod => ({ default: mod.AIRecommendationSearchBar })), {
  ssr: false,
  loading: () => (
...
const HomeContent = dynamic(() => Promise.resolve(function HomeContentComponent({ products }: { products: Product[] }) {
  // 検索処理（現在はコンソールログのみ、後でルーティングを実装）
  const handleSearch = (query: string) => {
    console.log('検索クエリ:', query);
    // TODO: 検索結果ページへのリダイレクトを実装
  };

  return (
    <>
      {/* 大型検索窓（AIレコメンド機能付き） - 要件2.1に準拠 */}
  ...
  return (
    <div className="min-h-screen scroll-smooth">
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100">
        ...
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-gradient-to-br from-secondary-400/20 to-secondary-600/20 rounded-full blur-xl animate-pulse-gentle" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-indigo-400/20 to-purple-600/20 rounded-full blur-lg animate-bounce-gentle" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="text-center max-w-5xl mx-auto">
            <div className="animate-fade-in">
              ...
              <p className="text-2xl md:text-3xl text-gray-700 mb-12 font-medium text-balance">
                <span className="gradient-text font-bold">最も安い価格で。</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <a href="/compare" className="btn-primary text-lg px-8 py-4 shadow-strong">
                  <span className="flex items-center gap-3">
                    <span className="text-2xl">🔍</span>
                    商品を比較する
                  </span>
                </a>
                <a href="#products" className="btn-secondary text-lg px-8 py-4 shadow-medium">
                  <span className="flex items-center gap-3">
                    <span className="text-2xl">⭐</span>
                    おすすめ商品を見る
                  </span>
              ...
              {/* 信頼性指標 */}
              <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                <div className="glass-effect rounded-2xl p-6 shadow-soft">
                  <div className="text-3xl mb-2">🛡️</div>
                  <div className="text-2xl font-bold text-primary-600 mb-1">安全性重視</div>
                  <div className="text-gray-600">科学的エビデンス基準</div>
                </div>
                <div className="glass-effect rounded-2xl p-6 shadow-soft">
                  <div className="text-3xl mb-2">💰</div>
                  <div className="text-2xl font-bold text-secondary-600 mb-1">価格最適化</div>
                  <div className="text-gray-600">実効コスト分析</div>
                </div>
                <div className="glass-effect rounded-2xl p-6 shadow-soft">
                  <div className="text-3xl mb-2">🤖</div>
                  <div className="text-2xl font-bold text-indigo-600 mb-1">AI推奨</div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b-2 border-primary-100">
                        <th className="text-left py-6 px-6 font-bold text-gray-800 text-lg">商品名</th>
                        <th className="text-left py-6 px-6 font-bold text-gray-800 text-lg">価格</th>
                        <th className="text-left py-6 px-6 font-bold text-gray-800 text-lg">容量</th>
                        <th className="text-left py-6 px-6 font-bold text-gray-800 text-lg">1日摂取量</th>
                        <th className="text-left py-6 px-6 font-bold text-gray-800 text-lg">実効コスト/日</th>
                      </tr>
                    </thead>
                    <tbody>
                      {products.map((product, index) => {
                        ...
                        return (
                          <tr key={index} className="border-b border-gray-100 hover:bg-gradient-to-r hover:from-primary-50/50 hover:to-secondary-50/50 transition-all duration-300">
                            ...
                            <td className="py-6 px-6">
                              {costError ? (
                                <span className="text-red-500 font-bold text-lg">計算不可</span>
                              ) : (
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 w-32 h-32 bg-gradient-to-br from-secondary-300/20 to-indigo-300/20 rounded-full blur-xl animate-pulse-gentle" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <a href="/ingredients?category=vitamins" className="group">
              <div className="glass-effect rounded-3xl p-8 text-center shadow-soft hover:shadow-strong transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">ビタミン</h3>
            ...
            <a href="/ingredients?category=minerals" className="group">
              <div className="glass-effect rounded-3xl p-8 text-center shadow-soft hover:shadow-strong transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">ミネラル</h3>
                <p className="text-gray-600 text-sm">
            ...
            <a href="/ingredients?category=amino-acids" className="group">
              <div className="glass-effect rounded-3xl p-8 text-center shadow-soft hover:shadow-strong transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">アミノ酸</h3>
                <p className="text-gray-600 text-sm">
          ...
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-8">目的別で選ぶ</h3>
          </div>
            ...
            <a href="/ingredients?purpose=fatigue" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">疲労回復</h4>
                    <p className="text-gray-600 text-sm">エネルギー代謝をサポート</p>
                  </div>
                </div>
              </div>
            </a>
            ...
            <a href="/ingredients?purpose=beauty" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">美容・アンチエイジング</h4>
                    <p className="text-gray-600 text-sm">肌と髪の健康をサポート</p>
                  </div>
                </div>
              </div>
            </a>
            ...
            <a href="/ingredients?purpose=immunity" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">免疫力向上</h4>
            ...
            <a href="/ingredients?purpose=brain" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">脳機能・集中力</h4>
            ...
            <a href="/ingredients?purpose=sleep" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">睡眠・リラックス</h4>
                    <p className="text-gray-600 text-sm">質の良い睡眠をサポート</p>
                  </div>
                </div>
              </div>
            </a>
            ...
            <a href="/ingredients?purpose=sports" className="group">
              <div className="glass-effect rounded-2xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-1">スポーツ・筋力</h4>
                    <p className="text-gray-600 text-sm">運動パフォーマンス向上</p>
                  </div>
                </div>
              </div>
            </a>
